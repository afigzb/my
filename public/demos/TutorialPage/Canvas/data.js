...
// 在头部预加载所有HTML文件内容
// 基础教学文件
const overviewHtml = await loadHtmlAsString('../../TutorialPage/Canvas/概要.html');
const basicShapesHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/基础形状绘制.html');
const transformHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/变换操作.html');
const pathsHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/路径和曲线.html');
const gradientHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/渐变效果.html');
const textHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/文字渲染.html');
const patternHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/图案填充.html');
const interactiveDrawHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/互动绘图工具.html');
const simpleGameHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/简单游戏.html');
const uiComponentHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/UI组件.html');
const engineeringHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/工程绘图.html');
const financialChartHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/金融图表.html');
const onlineDesignHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/在线设计工具.html');
const dashboardHtml = await loadHtmlAsString('../../TutorialPage/Canvas/基础教学/数据仪表板.html');

// 深入教学文件
const cube3DHtml = await loadHtmlAsString('../../TutorialPage/Canvas/深入教学/3D立方体旋转.html');
const advancedDrawHtml = await loadHtmlAsString('../../TutorialPage/Canvas/深入教学/高级绘图工具.html');
const particleEngineHtml = await loadHtmlAsString('../../TutorialPage/Canvas/深入教学/粒子物理引擎.html');
const fluidAnimationHtml = await loadHtmlAsString('../../TutorialPage/Canvas/深入教学/流体动画模拟.html');
const realtimeFilterHtml = await loadHtmlAsString('../../TutorialPage/Canvas/深入教学/实时滤镜效果.html');
const starFieldHtml = await loadHtmlAsString('../../TutorialPage/Canvas/深入教学/星空穿梭效果.html');
